...
#NAME_PRJ = '2017issue2'
#NAME_PRJ = 'new'
#NAME_JOUR = 'Engineering_Sciences'
#NAME_PRJ = '2017_3'
NAME_JOUR = 'Test'
NAME_PRJ = '2017_1'
#NAME_JOUR = 'Frontiers of Information Technology & Electronic Engineering'
#NAME_PRJ = '2017_1'
#NAME_JOUR = 'Frontiers of Engineering Management'
#NAME_PRJ = 'FEM Volume 4 Issue 1'
#NAME_JOUR = '20171118'
#NAME_PRJ = '20171118'
...
SVM_MOD_PATH = join(DAT_DIR, 'svm-model.pkl')
MLP_MOD_PATH = join(DAT_DIR, 'MLP.pkl')
IP_INFO_PATH = join(DAT_DIR, 'ip_info.json')
IP_SOCKS_INFO_PATH = join(DAT_DIR, 'ip_socks_info.json')
